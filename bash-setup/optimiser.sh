...
$MYSQLCALL 'insert into HOSTS (hostId, date, maxJobs, cename, Version, maxqueued, queues, status, hostPort, rating, connected, hostName, siteId, commandName, adminName) values (12277789, NULL, 400, "LOCALHOST::JTESTSITE:FIRSTCE", "v2-19.395", 5, NULL, "CONNECTED", 1094, NULL, 1, "localhost.localdomain", 1, NULL, NULL);'
while :
do
        echo \"Optimizing\"
        ...
        $MYSQLCALL 'insert into JOBAGENT (entryId,priority,noce,fileBroker,`partition`,disk,ttl,ce,userId,packages,site,counter,price,oldestQueueId,revision) values (1,100,"",0,",,",0,0,",LOCALHOST::JTESTSITE::FIRSTCE,",1235890,"%",",JTESTSITE,",1,1,0,0);'
