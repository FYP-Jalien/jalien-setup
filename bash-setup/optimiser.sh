...
do
        ...
        #$MYSQLCALL 'insert into JOBAGENT (entryId,priority,noce,fileBroker,`partition`,disk,ttl,ce,userId,packages,site,counter,price,oldestQueueId,revision,cpucores) values (1,100,"",0,"%",0,0,",ALICE::JTestSite::secondce,",1235890,"%",",JTestSite,",1,1,0,0,4);'
        $MYSQLCALL 'insert into JOBAGENT (entryId,priority,noce,fileBroker,`partition`,disk,ttl,ce,userId,packages,site,counter,price,oldestQueueId,revision,cpucores) values (1,100,"",0,"%",0,0,",ALICE::JTestSite::firstce,",1235890,"%",",JTestSite,",1,1,0,0,1);'
